...
<script type="text/javascript">
  $(function(){
	  ...
	  $("#loadBtn").click(function(){
		  $("#display").load("load"); //RequestMapping("/load")로 감
	  });
	  /////////////////////////////////
	...
	$("#dtoBtn").click(function(){
		$.ajax({
			...
			success: function(result){
				...
				$("#display").html(result.id + " | " + result.name + " | " + result.age + " | "
						+ result.addr);
			},
			error: function(err){
				alert(err + "에러 발생!!!")
...
/////////////////////////////////////////////////////
	...
	//dateType = "text"였을때 오류!! Uncaught TypeError: Cannot use 'in' operator to search for ....
